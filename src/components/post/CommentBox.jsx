  ...
  return (
    <>
      ...
      <div name="post" className="relative mx-2">
        <input
          className={`w-full h-[40px] rounded-[10px] border-0 py-5 pl-7 pr-20 text-[16px] ${commentError ? 'ring-red-500' : 'ring-gray-300'} text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1.5 focus:ring-inset focus:ring-[#0D0B5F] text-sm font-light`}
